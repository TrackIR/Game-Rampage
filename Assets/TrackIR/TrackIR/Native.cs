...
// * Description:
// *
// *   TrackIR API data structures and functions used for connecting applications
// *   to TrackIR and sending tracking data information. Requires .NET Framework 
// *   functions for loading DLL and searching registry.
// * 
// *******************************************************************************
...
//      private float[] Reserved;
    ...
    public class NativeClientLibrary
    {
        ...
        public NP_GetDataEX_Delegate NP_GetDataEX { get; private set; }
