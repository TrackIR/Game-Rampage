...
// * Description:
// *
// *   C# Unity code for connecting to TrackIR, polling for tracking data, and shutting down
// *   connection to TrackIR.
// * 
// *******************************************************************************
...
namespace NaturalPoint.TrackIR
{
    public class Client
    {
        ...
        /// Only a select few games use app-key encryption. You will likely not need to interact with this.
        /// </summary>
        UInt16 m_appId;
